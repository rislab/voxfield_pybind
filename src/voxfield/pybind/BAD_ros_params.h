...
#include "ros_emulator.h"

namespace ros=ros_emulator;

inline voxblox::TsdfMap::Config getTsdfMapConfigFromRosParam(
...
inline voxblox::ICP::Config getICPConfigFromRosParam(const ros::NodeHandle& nh_private) {
  voxblox::ICP::Config icp_config;
...
inline voxblox::TsdfIntegratorBase::Config getTsdfIntegratorConfigFromRosParam(
    const ros::NodeHandle& nh_private) {
  voxblox::TsdfIntegratorBase::Config integrator_config;

  integrator_config.voxel_carving_enabled = true;

  const voxblox::TsdfMap::Config tsdf_config = voxblox::getTsdfMapConfigFromRosParam(nh_private);
...
inline voxblox::NpTsdfIntegratorBase::Config getNpTsdfIntegratorConfigFromRosParam(
    const ros::NodeHandle& nh_private) {
  voxblox::NpTsdfIntegratorBase::Config integrator_config;
...
inline voxblox::EsdfMap::Config getEsdfMapConfigFromRosParam(
    const ros::NodeHandle& nh_private) {
...
inline voxblox::EsdfIntegrator::Config getEsdfIntegratorConfigFromRosParam(
    const ros::NodeHandle& nh_private) {
...
inline voxblox::MeshIntegratorConfig getMeshIntegratorConfigFromRosParam(
    const ros::NodeHandle& nh_private) {
...
inline voxblox::OccupancyMap::Config getOccupancyMapConfigFromRosParam(
    const ros::NodeHandle& nh_private) {
  ...
  occ_config.occupancy_voxel_size = static_cast<voxblox::FloatingPoint>(voxel_size);
  occ_config.occupancy_voxels_per_side = voxels_per_side;

  return occ_config;
}

inline voxblox::OccTsdfIntegrator::Config getOccTsdfIntegratorConfigFromRosParam(
    const ros::NodeHandle& nh_private) {
  voxblox::OccTsdfIntegrator::Config integrator_config;
...
inline voxblox::EsdfMap::Config getEsdfMapConfigFromOccMapRosParam(
    const ros::NodeHandle& nh_private) {
  voxblox::EsdfMap::Config esdf_config;

  const voxblox::OccupancyMap::Config occ_config =
...
inline voxblox::TsdfMap::Config getTsdfMapConfigFromOccMapRosParam(
    const ros::NodeHandle& nh_private) {
  voxblox::TsdfMap::Config tsdf_config;
...
inline voxblox::TsdfMap::Config getTsdfMapConfigFromEsdfMapRosParam(
    const ros::NodeHandle& nh_private) {
  voxblox::TsdfMap::Config tsdf_config;

  const voxblox::EsdfMap::Config esdf_config = getEsdfMapConfigFromRosParam(nh_private);
...
inline voxblox::EsdfVoxfieldIntegrator::Config
getEsdfVoxfieldIntegratorConfigFromRosParam(const ros::NodeHandle& nh_private) {
  voxblox::EsdfVoxfieldIntegrator::Config esdf_integrator_config;
...
inline voxblox::EsdfOccFiestaIntegrator::Config
getEsdfOccFiestaIntegratorConfigFromRosParam(
    const ros::NodeHandle& nh_private) {  // NOLINT
  voxblox::EsdfOccFiestaIntegrator::Config esdf_integrator_config;
...
inline voxblox::EsdfOccEdtIntegrator::Config getEsdfEdtIntegratorConfigFromRosParam(
    const ros::NodeHandle& nh_private) {
  voxblox::EsdfOccEdtIntegrator::Config esdf_integrator_config;
